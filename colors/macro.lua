...
-- License:      GPL-3.0
-- Last Updated: Thu Jan 18 07:59:02 PM CST 2024
...
local hlgroups = {
  ...
  ['@text.title.1.markdown'] = { fg = c_macroRed },
  ['@text.title.2.markdown'] = { fg = c_macroRed },
  ['@text.title.3.markdown'] = { fg = c_macroRed },
  ['@text.title.4.markdown'] = { fg = c_macroRed },
  ['@text.title.5.markdown'] = { fg = c_macroRed },
  ['@text.title.6.markdown'] = { fg = c_macroRed },
  ...
  ['@text.todo.unchecked'] = { fg = c_macroRed },
