...
vim.keymap.set('n', '<Leader>fo', function() M.telescope_builtin.oldfiles() end, { noremap = true, silent = true })
...
vim.keymap.set('n', '<Leader>fb', function() M.telescope_builtin.current_buffer_fuzzy_find() end, { noremap = true, silent = true })
...
vim.keymap.set('n', '<Leader>ft', function() M.telescope_builtin.lsp_type_definitions() end, { noremap = true, silent = true })
...
vim.keymap.set('n', '<Leader>fg', function() M.telescope_builtin.git_files() end, { noremap = true, silent = true })
