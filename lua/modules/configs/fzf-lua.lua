...
fzf.setup {
  ...
  nbsp = not true and "\xc2\xa0" or nil,
...
keymap("n", "<Leader>fH", fzf.highlights, "[Fzf] highlights")
keymap("n", "<Leader>f'", fzf.resume)
keymap("n", "<Leader>fA", fzf.autocmds)
keymap("n", "<Leader>fb", fzf.buffers)
keymap("n", "<Leader>fC", fzf.changes)
keymap("n", "<Leader>fc", fzf.colorschemes)
...
keymap("n", "<Leader>fQ", fzf.quickfix_stack)
keymap("n", "<Leader>fgt", fzf.git_tags)
keymap("n", "<Leader>fgs", fzf.git_stash)
keymap("n", "<Leader>fgg", fzf.git_status)
...
keymap("n", "<Leader>fD", fzf.lsp_typedefs)
keymap("n", "<Leader>fd", fzf.lsp_definitions)
keymap("n", "<Leader>fs", fzf.lsp_document_symbols)
keymap("n", "<Leader>fS", fzf.lsp_live_workspace_symbols)
keymap("n", "<Leader>fi", fzf.lsp_implementations)
keymap("n", "<Leader>f<", fzf.lsp_incoming_calls)
